...
const DirectFire = (msg) => {
    ...
    if (type === "AI" && weapons.length > 1) {
        ...
        if (weapon.ai !== "-" && weapons[1].ai !== "-") {
            ...
            if (closeCombat === false && weapon.range === "C") {
                ai1 = -100;
            }
            if (closeCombat === false && weapons[1].range === "C") {
                ai2 = -100;
            }
            if (ai2 > ai1) {
                weapon = weapons[1];
    ...
    if (type === "Armour" && weapons.length > 1) {
        if (weapon.pen === "-" && weapons[1].pen !== "-") {
            weapon = weapons[1];
        }
        if (weapon.pen !== "-" && weapons[1].ai !== "-") {
